  ...
  return (
    <div className="min-h-screen bg-surface-950 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-60 -right-60 w-[500px] h-[500px] bg-brand-700/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-60 -left-60 w-[500px] h-[500px] bg-brand-900/20 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-md animate-slide-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-brand-600 rounded-2xl mb-4 shadow-xl shadow-brand-900/60 ring-1 ring-brand-500/30">
            <Layers className="w-7 h-7 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white tracking-tight">TaskFlow</h1>
          <p className="text-surface-500 mt-1 text-sm">Organize. Priorize. Entregue.</p>
        </div>

        {/* Card */}
        <div className="bg-surface-900 border border-surface-800 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-xl font-semibold text-surface-100 mb-6">Entrar na sua conta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="btn-primary w-full py-2.5 rounded-xl text-base font-semibold mt-2"
            >
              {loading
